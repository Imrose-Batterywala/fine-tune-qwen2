...
- trackio:https://huggingface.co/spaces/imrose/qwen2-7b-instruct-trl-sft-ChartQA-trackio
- sft
- trl
- trackio
licence: license
...
generator = pipeline("text-generation", model="imrose/qwen2-7b-instruct-trl-sft-ChartQA", device="cuda")
